...
export const TULI_CREATIONS_BY_USER = gql`
  {
    users {
      creations {
        id
...
/**
 * Returns gql query to retrieve all Tuli posts by owner
 * @param {String} owner address
 * @returns {gql} query with template string embedded
 */
export const TULI_MEDIA_BY_OWNER = (owner) => {
  return gql`
    {
...
/**
 * Calculates maximum number of Tuli media items
 * @param {Object[]} users
 * @returns {Number} max number of Tuli media items
 */
