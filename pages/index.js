...
import { calculateLatestCreation, TULI_CREATIONS_BY_USER } from "@data/queries"; // queries
...
export default function Home() {
  ...
  const collectInitialPosts = async () => {
    // Collect all users
    const allUsers = await client.request(TULI_CREATIONS_BY_USER);
    ...
    Tuli.Work Gallery
      ...
      <div className={styles.subheader}>
        <span>
          ...
          <a
            href="https://github.com/kittylabsbsc/r.tuli.work"
            target="_blank"
            rel="noopener noreferrer"
          >
            open-source
          </a>{" "}
        <br />  Four EVM chain <b>(Ethereum-mainnet, Ethereum Rinkeby, Binance Smart Chain & Polygon [ETH L2])</b><br />  based minimal interface to{" "}
          <a
            href="https://tuli.ink"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <b><br /> Main exhange token BEP20 for BSC are WBNB & KITTY </b>.
        </span>
      </div>
